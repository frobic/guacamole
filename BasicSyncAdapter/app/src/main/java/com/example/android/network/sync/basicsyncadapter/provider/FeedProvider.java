    ...
    static class FeedDatabase extends SQLiteOpenHelper {
        ...
        private static final String SQL_CREATE_ENTRIES =
                "CREATE TABLE " + FeedContract.Entry.TABLE_NAME + " (" +
                        ...
                        FeedContract.Entry.COLUMN_NAME_DECIBEL + TYPE_TEXT + COMMA_SEP +
                        FeedContract.Entry.COLUMN_NAME_VIBRATION    + TYPE_TEXT + COMMA_SEP +
                        FeedContract.Entry.COLUMN_NAME_REPETITION + TYPE_TEXT + COMMA_SEP +
                        FeedContract.Entry.COLUMN_NAME_RECAP + TYPE_TEXT + COMMA_SEP +
                        FeedContract.Entry.COLUMN_NAME_TIME + TYPE_INTEGER +")";
